...
When both images are download to your local drive, place them both into the folder that contains the `isleta_UTM13.shp` and the R script. Now were ready for statistical analysis. 
